  ...
  return (
    <main className="min-h-screen bg-background px-6 py-10 text-foreground sm:px-10 lg:px-16">
      <div className="mx-auto flex w-full max-w-6xl gap-10">
        <div className="hidden h-fit w-56 shrink-0 animate-pulse rounded-2xl bg-zinc-900/50 p-4 lg:block">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="h-96 w-full animate-pulse rounded-3xl bg-zinc-900/50" />
        </div>
      </div>
    </main>
  );
