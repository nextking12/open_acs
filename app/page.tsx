  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      <section className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-center px-6 py-16 sm:px-10 lg:px-16">
        <div className="absolute inset-x-6 top-8 h-px bg-gradient-to-r from-transparent via-[#d8c2a6]/70 to-transparent" />
        <div className="space-y-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              href="/courses"
              className="inline-flex h-12 items-center justify-center rounded-full bg-[#e4d3bf] px-6 text-sm font-semibold text-zinc-950 transition hover:bg-[#efe3d4]"
            >
              Browse courses
            </Link>
          </div>
